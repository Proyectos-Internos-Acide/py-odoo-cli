...
# Safe Python code without any imports (like re) that triggers safe_eval error
replacement_code = """try:
    ...
    if record.description and 'DETALLES DEL TOUR (FORMULARIO CUSTOM)' in record.description:
        ...
        if client_name:
            result_lines.append('Cliente: ' + str(client_name))
...
print("Odoo Action 582 write result:", res)
