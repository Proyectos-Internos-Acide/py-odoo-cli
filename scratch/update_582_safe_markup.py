...
new_header_block = """try:
    ...
    if record.description and 'DETALLES DEL TOUR (FORMULARIO CUSTOM)' in record.description:
        ...
        # Inyectar Cliente, Email y Telefono marcandolos como Markup seguro
        ...
        if h_idx != -1:
            ...
            if end_tag != -1:
                ...
                if extra_lines:
                    ...
                    # Castear con la misma clase Markup para evitar escape automatico
                    safe_extra = raw_markup.__class__(extra_str)
