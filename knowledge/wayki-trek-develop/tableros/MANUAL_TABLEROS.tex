...
\title{\textbf{Manual de Tableros (Dashboards) - Wayki Trek}}
\author{Wayki Trek - Odoo CRM}
\date{\today}
...
\section{Tablero de Ventas (Sales)}
...
\subsection*{Análisis de las métricas y gráficos disponibles:}
...
\subsection*{Tablas de Ranking y Desempeño:}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        \item Muestran las negociaciones de mayor valor económico. Detallan el Cliente, el Vendedor a cargo y el monto potencial o cerrado (Revenue).
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{screenshots/tablero_5_sales.png}
    \caption{Tablero de Ventas}
\end{figure}

\clearpage

\section{Tablero de Productos (Product)}
...
\subsection*{Tablas de Ranking y Detalle:}
\begin{itemize}[leftmargin=*]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{screenshots/tablero_6_product.png}
    \caption{Tablero de Productos}
\end{figure}

\clearpage

\section{Tablero de Leads (Prospectos)}
...
\subsection*{Tablas de Ranking y Segmentación:}
\begin{itemize}[leftmargin=*]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{screenshots/tablero_1_leads.png}
    \caption{Tablero de Leads}
\end{figure}

\clearpage

\section{Tablero de Flujo (Pipeline)}
...
\subsection*{Tablas de Ranking y Análisis Estratégico:}
\begin{itemize}[leftmargin=*]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{screenshots/tablero_2_pipeline.png}
    \caption{Tablero de Flujo}
\end{figure}

\clearpage

\section{Tablero de Marketing por Correo (Email Marketing)}
...
\subsection*{Tablas de Ranking y Monitoreo de Campañas:}
\begin{itemize}[leftmargin=*]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{screenshots/tablero_3_email_marketing.png}
