...
def main():
    ...
    print_action_id, client_print_action_id, save_action_id = run_reports(client, wizard_model)
    run_views(client, wizard_model, print_action_id, client_print_action_id, save_action_id)
