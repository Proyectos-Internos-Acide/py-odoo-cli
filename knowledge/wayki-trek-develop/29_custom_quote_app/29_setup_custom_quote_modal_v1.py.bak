...
- El PDF usa plantilla QWeb propia ``wtk.report_custom_quote_document`` (diseño Wayki Trek, ``key`` = ``report_name``).
- La vista QWeb debe tener ``key == report_name`` (p. ej. ``wtk.report_custom_quote_document``);
  si no, Odoo SaaS asigna ``gen_key.*`` y el motor no encuentra la plantilla.
"""
                ...
                <div class="page" style="font-family: DejaVu Sans, Helvetica, Arial, sans-serif; color:#1a1a1a; font-size:11px; line-height:1.45;">
                            ...
                            <td style="width:50%; padding:10px 12px; vertical-align:top; background:#fafafa;">
                                <table style="width:100%; font-size:10px;">
                                    ...
                                    <tr t-if="doc.x_sale_order_id">
                                        ...
                                        <td style="text-align:right; font-weight:bold;"><span t-field="wiz_cur"/></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width:100%; max-width:100%; border-collapse:collapse; font-size:10px; border:1px solid #cbd5e1;">
                        ...
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Costo operativo por PAX (suma precios PAX)</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right; width:120px;"><span t-field="doc.x_operational_cost_pax" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Costo fijo / administrativos</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><span t-field="doc.x_fixed_cost" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Costo variable / otros</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><span t-field="doc.x_variable_cost" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr style="background:#ecfdf5;">
                            <td style="padding:7px 10px; border:1px solid #e5e7eb;"><strong>Total costos</strong></td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><strong><span t-field="doc.x_total_cost" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></strong></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Utilidad estimada</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><span t-field="doc.x_profit_amount" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;"><strong>Subtotal</strong></td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><strong><span t-field="doc.x_subtotal_amount" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></strong></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Impuesto (IGV o renta)</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><span t-field="doc.x_tax_amount" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;"><strong>Subtotal acumulado</strong></td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><strong><span t-field="doc.x_subtotal_after_tax" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></strong></td></tr>
                        <tr><td style="padding:7px 10px; border:1px solid #e5e7eb;">Comisión tarjetas</td>
                            <td style="padding:7px 10px; border:1px solid #e5e7eb; text-align:right;"><span t-field="doc.x_card_commission_amount" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></td></tr>
                        <tr style="background:#20603D; color:#ffffff;">
                            <td style="padding:10px 10px; border:1px solid #20603D; font-size:11px;"><strong>PRECIO FINAL</strong></td>
                            <td style="padding:10px 10px; border:1px solid #20603D; text-align:right; font-size:14px;"><strong><span t-field="doc.x_final_price" t-options="{'widget': 'monetary', 'display_currency': wiz_cur}"/></strong></td></tr>
                    </table>
